...
def extract_watermark(image_water_marked, image_water_mark_extract):
    ...
    imag_host_w=np.rot90(imag_host_w)
    ...
    imag_w_bin_w=(imag_w_bin_w_all[:watermark_size, :watermark_size]+np.rot90(imag_w_bin_w_all[:watermark_size, watermark_size:])+np.rot90(imag_w_bin_w_all[watermark_size:, :watermark_size],3)+np.rot90(imag_w_bin_w_all[watermark_size:, watermark_size:],2))/4
    print(imag_w_bin_w_all[:watermark_size, :watermark_size]==imag_w_bin_w)
